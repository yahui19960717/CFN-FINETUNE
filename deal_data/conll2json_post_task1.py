...
def obtain_submit_task1(file, f1):
     with open(file, 'r') as f, open(f1, "w", encoding="utf-8") as f_w:
        p_frame = []
        data = json.load(f) 
        for s in data:
            temp = [s["sentence_id"], s["frame"]]
            p_frame.append(temp)
        json.dump(p_frame, f_w, ensure_ascii=False)
...
if __name__=="__main__":
    ...
    #得到模型预测的结果
    pred_testB_10000_1 = "../SRL-as-GP/pred/testB.dataenhance.10000.seed1.pred"
    pred_testB_20000_1 = "../SRL-as-GP/pred/testB.dataenhance.20000.seed1.pred"
    pred_testB_1 = "../SRL-as-GP/pred/testB.seed1.pred"
    pred_testB_33 = "../SRL-as-GP/pred/testB.seed33.pred"
    # 获得预测
    pred_testB_10000_s = get_pred(pred_testB_10000_1) 
    pred_testB_20000_s = get_pred(pred_testB_20000_1) 
    pred_testB_1_s = get_pred(pred_testB_1) 
    pred_testB_33_s = get_pred(pred_testB_33) 

    # 获得json文件
    results_1 = get_final_results(pred_testB_10000_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zsl.dataenhance.10000.seed1.json", results_1)
    results_2 = get_final_results(pred_testB_20000_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zsl.dataenhance.20000.seed1.json", results_2)
    results_3 = get_final_results(pred_testB_1_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zsl.seed1.json", results_3)
    results_4 = get_final_results(pred_testB_33_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zsl.seed33.json", results_4)
    # 获得组织方要求的task1格式
    obtain_submit_task1("../data/pred_json/testB.zsl.dataenhance.10000.seed1.json", "../data/result-task1/B_task1_test-zsl-10000-seed1.json")
    obtain_submit_task1("../data/pred_json/testB.zsl.dataenhance.20000.seed1.json", "../data/result-task1/B_task1_test-zsl-20000-seed1.json")
    obtain_submit_task1("../data/pred_json/testB.zsl.seed1.json", "../data/result-task1/B_task1_test-zsl-seed1.json")
    obtain_submit_task1("../data/pred_json/testB.zsl.seed33.json", "../data/result-task1/B_task1_test-zsl-seed33.json")