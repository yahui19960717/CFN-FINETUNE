...
def obtain_submit_task3(file, f3):
     p_labels = []
     with open(file, 'r') as f, open(f3, "w", encoding="utf-8") as f_w:
        data = json.load(f) 
        for s in data:
            for arg in s["cfn_spans"]:
                temp = [s["sentence_id"],arg["start"], arg["end"], arg["fe_name"]]
                p_labels.append(temp)
        json.dump(p_labels, f_w, ensure_ascii=False)            
...
if __name__=="__main__":
    ...
    pred_testB_zy_777 = "../crfsrl/pred/testB.seed777.conllu"
    pred_testB_zy_10000_777 = "../crfsrl/pred/testB.dataenhance10000.seed777.conllu"
    # 转化成BES格式：
    BI2BES(pred_testB_zy_20000_777, "../crfsrl/pred/testB.BES.dataenhance20000.seed777.conllu")
    BI2BES(pred_testB_zy_777, "../crfsrl/pred/testB.BES.seed777.conllu")
    BI2BES(pred_testB_zy_10000_777,"../crfsrl/pred/testB.BES.dataenhance10000.seed777.conllu")
    # 获得预测并获得json文件
    pred_testB_20000_777_s = get_pred("../crfsrl/pred/testB.BES.dataenhance20000.seed777.conllu") 
    results_1 = get_final_results(pred_testB_20000_777_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zy.dataenhance.20000.seed777.json", results_1)
    pred_testB_777_s = get_pred( "../crfsrl/pred/testB.BES.seed777.conllu") 
    results_2 = get_final_results(pred_testB_777_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zy.seed777.json", results_2)
    pred_testB_10000_777_s = get_pred("../crfsrl/pred/testB.BES.dataenhance10000.seed777.conllu") 
    results_3 = get_final_results(pred_testB_10000_777_s, testB_s, id2frame)
    data2json("../data/pred_json/testB.zy.dataenhance.10000.seed777.json", results_3)

    # 获得组织方要求的task3格式"
    obtain_submit_task3("../data/pred_json/testB.zy.dataenhance.20000.seed777.json", "../data/result-task3/B_task3_test_20000_777.json")
    obtain_submit_task3("../data/pred_json/testB.zy.dataenhance.10000.seed777.json", "../data/result-task3/B_task3_test_10000_777.json")
    obtain_submit_task3("../data/pred_json/testB.zy.seed777.json", "../data/result-task3/B_task3_test_777.json") 
